...
begin
  ...
  //Application.OnHelp := HelpHook;            TODO: this doesn't work
...
function THookHelpSystem.HelpHook(Command: Word; Data: Integer; Var CallHelp: Boolean) : Boolean;
begin
   if _DebugMode then
