...
type
  ...
  {: This type defines the procedure used by a <See Class=TViewport>
...
{: This is the type of an event handler for the mouse move event.
  ...
  public
    ...
    {: This property may contains a <See Class=TGraphicObjList> instance
       ...
       in the <See Method=TViewport@Repaint> method. Otherwise the
  ...
  published
    ...
    {: This property may contains an event handler that is called when
       ...
       filling with the <See Property=TViewport@BackgroundColor> color.
...
begin
  ...
  {UnitLength := (OwnerDrawing as TDrawing2D).PicUnitLength;
  Scale := (OwnerDrawing as TDrawing2D).PicScale;}
...
procedure TViewport.SetOnClearCanvas(const H: TClearCanvas);
begin
  StopRepaint;
  fOnClear := H;
  Repaint;
...
begin
  ...
  if Assigned(fOnClear) then
    fOnClear(Self, fOffScreenCanvas, ARect,
      fBackGroundColor)
  else
